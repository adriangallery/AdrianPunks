...
// Use window.ALCHEMY_API_KEY from GitHub Secrets if available, otherwise fallback
const ALCHEMY_API_KEY = (typeof window !== 'undefined' && window.ALCHEMY_API_KEY) || 'YOUR_ALCHEMY_API_KEY';
